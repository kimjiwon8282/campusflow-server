...
@Schema(description = "학생 수강편람 검색 조건")
public record StudentCatalogCourseSearchRequest(
    @Schema(description = "검색 모드. condition 또는 direct. 생략, blank, all이면 condition으로 처리하며 그 외 값은 CATALOG_001 에러", example = "condition")
    String mode,
